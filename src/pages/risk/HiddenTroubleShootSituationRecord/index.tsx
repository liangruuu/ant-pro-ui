    ...
    <PageHeaderWrapper>
      <Form>
        ...
        <Card style={{ textAlign: "right" }}>
          <Button type="primary" onClick={() => { message.success("保存成功"); router.replace('/risk/hiddentroubleshootsituation'); }}>保存</Button>
          <Button style={{marginLeft: "10px"}} onClick={() => router.replace('/risk/hiddentroubleshootsituation')}>取消</Button>
        </Card>
      </Form >
    </PageHeaderWrapper >
  )
