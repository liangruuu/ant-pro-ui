    ...
    <PageHeaderWrapper>
      <Form>
        ...
        <Card style={{ textAlign: "right" }}>
          <Button type="primary" onClick={() => { message.success("保存成功"); router.replace('/risk/tbdhiddentroublelist'); }}>保存</Button>
          <Button style={{marginLeft: "10px"}} onClick={() => router.replace('/risk/tbdhiddentroublelist')}>取消</Button>
        </Card>
      </Form >
    </PageHeaderWrapper >
  )
