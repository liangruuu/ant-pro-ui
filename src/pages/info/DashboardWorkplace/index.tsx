import { Avatar, Card, Col, Skeleton, Row } from 'antd';
    ...
    <div className={styles.pageHeaderContent}>
      ...
      <div className={styles.content}>
        ...
        <div>
          ...
          {currentUser?.userInfo?.title?.map(item => `${item} | `)}
          <BankOutlined /> {currentUser?.userInfo?.entName}
        </div>
      </div>
    </div>
  );
...
const DashboardWorkplace: React.FC<DashboardWorkplaceProps> = props => {
  const {
    user: { currentUser },
    // activities,
    // projectNotice,
  ...
  // });
  // if (firstRender) {
  //   if (currentUser?.userInfo != null && currentUser.userInfo.entid != null) {
  //     dispatch({
